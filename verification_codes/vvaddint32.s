...
loop:     
    ...
    // Non-vector instructions are indented  
     addi a0, x0, 0x8 // Application Vector length
...
vvaddint8:
    vsetvli t0, a0, e32,m1,tu,mu  // Set vector length based on 32-bit vectors
    vle32.v v1, (a1)         // Get first vector
    sub a0, a0, t0           // Decrement number done
    slli t0, t0, 2           // Multiply number done by 4 bytes
    add a1, a1, t0           // Bump pointer
    vle32.v v2, (a2)         // Get second vector
    add a2, a2, t0           // Bump pointer
    vadd.vv v3, v1, v2       // Sum vectors
    vse32.v v3, (x1)         // Store result
